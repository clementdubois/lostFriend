...
module Sergi #:nocdoc:
  module Acts #:nocdoc:
    module Messageable #:nocdoc:
      ...
      module ClassMethods
        #enables a class to send and receive messages to members of the same class - currently assumes the model is of class type 'member', 
      ...
      module InstanceMethods
        #returns an instance of class type Mailbox - this object essentially wraps the member's mail messages and provides a clean interface for accessing them. 
        ...
        #====params:
        #recipients::
        #     a single member object or array of members to deliver the message to.
        #msg_body::
        ...
        #
        #*explicitly calling this method is rare unless you are replying to a subset of the members involved in the conversation or 
        ...
        #recipients::
        #     a single member object or array of members to deliver the reply message to.
        #reply_body::
        ...
        #sends a Mail to all members involved in the given conversation (excluding yourself).
        #
        #*this may have undesired effects if members have been added to the conversation after it has begun.
        #
        #====params:
        #conversation::
        #     the Conversation object that the mail you are responding to belongs.
        ...
        #returns an array of the member's Mail associated with the given conversation. 
